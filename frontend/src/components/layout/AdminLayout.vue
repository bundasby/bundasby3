...
const menuItems = [
  ...
  { name: 'Jenis Berita', icon: 'tag', route: '/admin/categories' },
          ...
          <ul class="space-y-1">
            <li v-for="item in menuItems" :key="item.name">
              ...
              >
                ...
                <!-- Slider Icon -->
                <svg v-if="item.icon === 'slider'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <!-- Document Icon -->
                <svg v-if="item.icon === 'document'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <!-- Tag Icon -->
                <svg v-if="item.icon === 'tag'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Chat Alt Icon -->
                <svg v-if="item.icon === 'chat-alt'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
