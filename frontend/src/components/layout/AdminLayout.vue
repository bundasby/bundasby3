...
const menuItems = [
  ...
  { name: "Publikasi & Informasi", icon: "document", route: "/admin/publikasi" },
  { name: "Bunda PAUD", icon: "users", route: "/admin/bunda-paud" },
  { name: "Mitra PAUD", icon: "handshake", route: "/admin/mitra-paud" },
  { name: "Gugus Tugas", icon: "clipboard-list", route: "/admin/gugus-tugas" },
  { name: "Data PAUD", icon: "database", route: "/admin/data-paud" },
  ...
  { name: "Profil", icon: "profile", route: "/admin/profiles" },
