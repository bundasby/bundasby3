...
const socialMedia = [
  { name: 'Instagram', url: 'https://instagram.com/bundapaudsurabaya', icon: 'instagram' },
...
onMounted(() => {
  ...
  contactInfo.value = {
    address: settings.address || contactInfo.value.address,
    phone: settings.phone || contactInfo.value.phone,
    email: settings.email || contactInfo.value.email,
    hours: settings.hours || contactInfo.value.hours,
    googleMapsUrl: settings.googleMapsUrl || contactInfo.value.googleMapsUrl
  }
})
