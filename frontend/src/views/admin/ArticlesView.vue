...
<template>
  <AdminLayout title="Kelola Berita">
    ...
    <div v-else-if="activeTab === 'berita'">
      ...
      <div class="flex items-center justify-between mb-6">
        <p class="text-gray-600 dark:text-gray-400">
          Manage articles dan pengumuman
        </p>
        <router-link
    ...
    <div v-else-if="activeTab === 'jenis'">
      ...
      <div class="flex items-center justify-between mb-6">
        <p class="text-gray-600 dark:text-gray-400">
          Tambah, edit, atau hapus jenis berita
        </p>
        <button
          @click="openAddModal"
          class="btn-primary flex items-center gap-2"
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tr v-if="categories.length === 0">
              <td colspan="4" class="px-6 py-12 text-center text-gray-500">
                Belum ada jenis berita. Klik "Tambah Jenis Berita" untuk
                membuat.
              </td>
            </tr>
          </tbody>
        ...
        <div class="p-6 space-y-4">
          ...
          <div>
            ...
            <span
              ...
              :class="getColorClass(currentCategory.color)"
            >
